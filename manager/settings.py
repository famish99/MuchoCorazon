...
ADMINS = (
    ('Huan Nguyen', 'anonamefantasy@gmail.com'),
)
...
DATABASES = {
    'default': {
        ...
        'NAME': 'tanto.db',                      # Or path to database file if using sqlite3.
...
STATIC_ROOT = '/home/media/MuchoCorazon/sitestatic'
